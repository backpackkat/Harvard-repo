---
files: [volume.c]
url: https://cs50.harvard.edu/x/2023/labs/4/volume/
window: [terminal]
---

# Lab 4: Volume

--C program to to modify the volume of an audio file.--
```
...
input represents the name of the original audio file, output represents the name of the new audio file that should be generated, and factor is the amount by which the volume of the original audio file should be scaled.
