...
--C program to simulate the inheritance of blood types for each member of a family..--
```
$ ./inheritance
...
## Testing:
Program should behave per the rules described in the background, & in the example below.
